<?php
session_start();
$_SESSION["onde_estou"] = 'montagem_os';
require ('./topo2.php');
require ('./funcoes.php');
?>
...
<div class="container-fluid mt-2 col-md-12">
	<h3>Montagens</h3>
					 <table class="table table-sm">
						...
						<?php
							if ($stmt = $con->prepare('SELECT o.id_os, o.id_cli, c.nome_cli ,o.id_func, o.id_serv, o.id_status, o.data_os, o.obs_os, o.semana_os FROM ordem_serv o, clientes c WHERE o.id_status = "2" AND o.id_cli = c.id_cli ORDER BY o.id_os ASC')) {
								$stmt->execute();
								$stmt->store_result();
