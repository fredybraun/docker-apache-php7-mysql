...
class PHPlot
{
    ...
    protected $default_colors = array(
        'SkyBlue', 'green', 'orange', 'blue', 'violet', 'DarkGreen', 'gold', 'peru',
         'cyan', 'salmon', 'SlateBlue', 'purple', 'magenta', 'aquamarine1', 'red', 'YellowGreen'
    );
    // protected $default_colors = array(
    //     'SkyBlue', 'green', 'orange', 'blue', 'purple', 'DarkGreen', 'gold', 'peru',
    //     'cyan', 'salmon', 'SlateBlue', 'YellowGreen', 'magenta', 'aquamarine1', 'red', 'violet'
    // );
