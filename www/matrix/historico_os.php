<?php
session_start();
$_SESSION["onde_estou"] = 'historico_os';
require ('./topo2.php');
require ('./funcoes.php');
?>
...
<div class="container-fluid mt-2 col-md-12">
	<h3>Medidas</h3>
					 <table class="table table-sm">
						...
						<?php
							if ($stmt = $con->prepare('SELECT o.id_os, o.id_cli, c.nome_cli ,o.id_func, o.id_serv, o.id_status, o.data_os, o.data_os_instalacao, o.obs_os FROM ordem_serv o, clientes c WHERE o.id_status = "5" AND o.id_cli = c.id_cli ORDER BY o.id_os DESC')) {
								$stmt->execute();
								$stmt->store_result();
								$num_of_rows = $stmt->num_rows;
								if ($stmt->num_rows > 0) {
									$stmt->bind_result($id_os, $id_cli, $nome_cli, $id_func, $id_serv, $id_status, $data_os, $data_os_instalacao, $obs_os);
									while ($stmt->fetch()) {
										$datetime1 = date_create($data_os);
										$datetime2 = date_create($data_os_instalacao);
						...
						?>
								    	<tr style="background:<?php echo $cor;?>">
										    <th scope="row" ><a href="dados_os.php?id_os=<?php echo $id_os; ?>"><?php echo $id_os; ?></a></th>
										    <?php
